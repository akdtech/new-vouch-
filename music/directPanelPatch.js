...
/*
 * DEATH Music 24/7 — focused player UI.
 * Only expose the controls people actually use from the panel:
 * Pause, Play, Skip, Queue, Autoplay, Volume - and Volume +.
 */
...
if (MusicManager.prototype.__deathDirectPanelPatched) return;
...
// Refresh is intentionally fire-and-forget for normal playback transitions.
const originalRefresh = MusicManager.prototype.refreshPanel;
MusicManager.prototype.refreshPanel = function fastStylishRefresh(guildId) {
  return Promise.resolve(originalRefresh.call(this, guildId)).catch(() => {});
};
